...
This file is created by `appstreamcli compose` and the error indicates
something else is wrong, for example the icon defined in desktop file
not existing. Please review additional errors if present.
...
The error means something else is wrong. Please review additional errors
if present.
